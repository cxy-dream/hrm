				    ...
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
					    	...
					    	身份证号码：<input name="cardId" maxLength="18" id="cardId"/>
					    </td>
					  </tr>
					  <tr>
					    <td class="font3">
							性别：
							<select name="sex" style="width:120px;" id="sex">
								<option value="0">--请选择性别--</option>
								<option value="1">男</option>
								<option value="2">女</option>
							</select>

					    	手机：<input name="phone" id="phone"/>
					    	所属部门ID：
							<select name="dept.id" style="width:120px;" id="dept.id">
